...
const VRDiv: React.FC = () => {
  ...
  const dynamicClasses = clsx({
    ...
    "top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-52": !vrMode,
  });
          ...
          <>
            <div className="absolute flex flex-row items-center gap-4 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <div className="border-4 border-gray-300 rounded-xl bg-cyan-800 w-72 h-44 overflow-hidden hover:cursor-not-allowed">
                <img src={"experiences/exp_3.png"} alt="Experience 3" className="w-96 h-64 object-cover rounded-lg filter brightness-50" />
              </div>
              <div className="border-4 border-gray-300 rounded-xl bg-cyan-800 w-96 h-52 overflow-hidden">
                <img src={"experiences/exp_1.png"} alt="Experience 1" className="w-96 h-64 object-cover rounded-lg filter brightness-50" />
              </div>
              <div className="border-4 border-gray-300 rounded-xl bg-cyan-800 w-72 h-44 overflow-hidden hover:cursor-not-allowed">
                <img src={"experiences/exp_2.png"} alt="Experience 2" className="w-96 h-64 object-cover rounded-lg filter brightness-50" />
              </div>
            </div>

            <h1 className="absolute bottom-0 w-full text-center text-4xl">
              &#8595; Tutorial &#8595;
            </h1>
          </>
        )}
